...
@InputType()
class ProductionProcessCreateNestedManyWithoutClientsInput {
...
export { ProductionProcessCreateNestedManyWithoutClientsInput as ProductionProcessCreateNestedManyWithoutClientsInput };
