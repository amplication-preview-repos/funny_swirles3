...
@InputType()
class UserAccountUpdateManyWithoutOrganizationsInput {
...
export { UserAccountUpdateManyWithoutOrganizationsInput as UserAccountUpdateManyWithoutOrganizationsInput };
