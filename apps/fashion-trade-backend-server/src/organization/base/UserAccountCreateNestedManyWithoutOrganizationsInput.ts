...
@InputType()
class UserAccountCreateNestedManyWithoutOrganizationsInput {
...
export { UserAccountCreateNestedManyWithoutOrganizationsInput as UserAccountCreateNestedManyWithoutOrganizationsInput };
