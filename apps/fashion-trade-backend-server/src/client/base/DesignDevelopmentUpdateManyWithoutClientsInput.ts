...
@InputType()
class DesignDevelopmentUpdateManyWithoutClientsInput {
...
export { DesignDevelopmentUpdateManyWithoutClientsInput as DesignDevelopmentUpdateManyWithoutClientsInput };
