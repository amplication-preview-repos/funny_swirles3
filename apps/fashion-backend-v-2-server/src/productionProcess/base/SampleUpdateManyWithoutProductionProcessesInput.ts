...
@InputType()
class SampleUpdateManyWithoutProductionProcessesInput {
...
export { SampleUpdateManyWithoutProductionProcessesInput as SampleUpdateManyWithoutProductionProcessesInput };
