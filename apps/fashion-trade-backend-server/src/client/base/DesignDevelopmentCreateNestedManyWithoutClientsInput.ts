...
@InputType()
class DesignDevelopmentCreateNestedManyWithoutClientsInput {
...
export { DesignDevelopmentCreateNestedManyWithoutClientsInput as DesignDevelopmentCreateNestedManyWithoutClientsInput };
