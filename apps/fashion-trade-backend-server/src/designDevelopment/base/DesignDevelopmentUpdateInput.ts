...
@InputType()
class DesignDevelopmentUpdateInput {
  @ApiProperty({
    required: false,
  ...
  @ApiProperty({
    required: false,
    type: () => ProductionUpdateManyWithoutDesignDevelopmentsInput,
  })
  @ValidateNested()
  @Type(() => ProductionUpdateManyWithoutDesignDevelopmentsInput)
  @IsOptional()
  @Field(() => ProductionUpdateManyWithoutDesignDevelopmentsInput, {
    nullable: true,
  })
...
export { DesignDevelopmentUpdateInput as DesignDevelopmentUpdateInput };
